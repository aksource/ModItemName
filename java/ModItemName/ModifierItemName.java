...
//		this.checkMap();
	...
	public void addModName()
	{
		...
		list0.add("strong");
		modStringJpMap.put(Enchantment.field_180310_c/*protection*/.effectId, listJp0);
		modStringMap.put(Enchantment.field_180310_c/*protection*/.effectId, list0);
		...
		listJp2.add("体が軽くなる");
		list2.add("feather");
		modStringJpMap.put(Enchantment.field_180309_e/*featherFalling*/.effectId, listJp2);
		modStringMap.put(Enchantment.field_180309_e/*featherFalling*/.effectId, list2);
		...
		modStringJpMap.put(Enchantment.field_180308_g/*projectileProtection*/.effectId, listJp4);
		modStringMap.put(Enchantment.field_180308_g/*projectileProtection*/.effectId, list4);
		List<String> list5 = new ArrayList<>();
		List<String> listJp5 = new ArrayList<>();
		listJp5.add("呼吸補助の付いた");
		listJp5.add("息が長く続く");
		list5.add("breath help");
		modStringJpMap.put(Enchantment.field_180317_h/*respiration*/.effectId, listJp5);
		modStringMap.put(Enchantment.field_180317_h/*respiration*/.effectId, list5);
		...
		listJp16.add("よく研がれた");
		list16.add("sharp");
		modStringJpMap.put(Enchantment.field_180314_l/*sharpness*/.effectId, listJp16);
		modStringMap.put(Enchantment.field_180314_l/*sharpness*/.effectId, list16);
		List<String> list17 = new ArrayList<>();
		List<String> listJp17 = new ArrayList<>();
		listJp17.add("死者殺しと言われる");
		list17.add("undead-killer");
		modStringJpMap.put(Enchantment.field_180315_m/*smite*/.effectId, listJp17);
		modStringMap.put(Enchantment.field_180315_m/*smite*/.effectId, list17);
		List<String> list18 = new ArrayList<>();
		List<String> listJp18 = new ArrayList<>();
		listJp18.add("虫狩りと呼ばれる");
		list18.add("arthropods-killer");
		modStringJpMap.put(Enchantment.field_180312_n/*baneOfArthropods*/.effectId, listJp18);
		modStringMap.put(Enchantment.field_180312_n/*baneOfArthropods*/.effectId, list18);
		List<String> list19 = new ArrayList<>();
		List<String> listJp19 = new ArrayList<>();
		listJp19.add("飛ばしに使われる");
		list19.add("knockback");
		modStringJpMap.put(Enchantment.field_180313_o/*knockback*/.effectId, listJp19);
		modStringMap.put(Enchantment.field_180313_o/*knockback*/.effectId, list19);
		...
		modStringJpMap.put(Enchantment.luckOfTheSea/*field_151370_z*/.effectId, listJp61);
		modStringMap.put(Enchantment.luckOfTheSea/*field_151370_z*/.effectId, list61);
		List<String> list62 = new ArrayList<>();
		List<String> listJp62 = new ArrayList<>();
		listJp62.add("釣りやすい");
		list62.add("easy-fishing");
		modStringJpMap.put(Enchantment.lure/*field_151369_A*/.effectId, listJp62);
		modStringMap.put(Enchantment.lure/*field_151369_A*/.effectId, list62);
	}
